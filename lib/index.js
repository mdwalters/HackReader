...
setInterval(function() {
    if (window.page == "new") {
        getAllNewStories(false);
    } else if (window.page == "top") {
        getAllTopStories(false);
    } else if (window.page == "best") {
        getAllBestStories(false);
    } else if (window.page == "ask") {
        getAllAskStories(false);
    } else if (window.page == "show") {
        getAllShowStories(false);
    }
}, 1000);